...
<div class="sidebar">
    ...
    <div class="navigation">
        <ul>
            ...
            <li>
                <a href="../home/playlist.html">
                    <span class="fa fas fa-book"></span>
                    <span>Songs</span>
                </a>
            </li>
            <li>
                <a href="../home/artist.html">
                    <span class="fa fas fa-book"></span>
                    <span>Artist</span>
                </a>
            </li>
...
<div class="main-container">
    ...
    <div class="policies">
        ...
        <button id="btn" name="button"    >INSERT
        </a>
        <button id="btn" name="button" value="" herf="playlistupdate.html">UPDATE
        <button id="btn" name="button" value="" herf="playlistinsertion.html">DELETE
     </div>
</div>
